...
/// Since DesignSystem-Debug is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "DesignSystem_DesignSystem_Debug"
        ...
        fatalError("unable to find bundle named DesignSystem_DesignSystem_Debug")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class DesignSystemDebugResources: NSObject {

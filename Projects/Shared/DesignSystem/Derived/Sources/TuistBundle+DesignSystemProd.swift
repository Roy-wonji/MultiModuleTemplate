...
/// Since DesignSystem-Prod is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "DesignSystem_DesignSystem_Prod"
        ...
        fatalError("unable to find bundle named DesignSystem_DesignSystem_Prod")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class DesignSystemProdResources: NSObject {

...
/// Since DesignSystem-Stage is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "DesignSystem_DesignSystem_Stage"
        ...
        fatalError("unable to find bundle named DesignSystem_DesignSystem_Stage")
    }()
}
